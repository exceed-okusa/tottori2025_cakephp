            ...
            exports.default = {
                ...
                methods: {
                    ...
                    checkBottomReached: function checkBottomReached() {
                        if ( this.scrollThresholdRestPercent === 0) {
                            return this.scrollEl.scrollTop + this.scrollEl.offsetHeight + 1 >= this.scrollEl.scrollHeight;
                        } else {
                            return this.scrollEl.scrollTop + this.scrollEl.offsetHeight + 1 >= ( this.scrollEl.scrollHeight * this.scrollReachThresholdPercent / 100 );
                        }
                    },
