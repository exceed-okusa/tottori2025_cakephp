                        ...
                        if ($formatData) {
                            ...
                            $returnValue[$rRef][$cRef] = PHPExcel_Style_NumberFormat::toFormattedString(
								...
								($style && $style->getNumberFormat()) ?
                                    ( $style->getNumberFormat()->getFormatCode() !== 'm/d/yy h:mm' ?
                                        ( $style->getNumberFormat()->getFormatCode() !== 'mm-dd-yy' ? $style->getNumberFormat()->getFormatCode() : 'yyyy/mm/dd' ) : 'yyyy/mm/dd h:mm' ) :
