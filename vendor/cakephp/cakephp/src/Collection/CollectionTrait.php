...
trait CollectionTrait
{
     ...
     *
     */
    public function match(array $conditions, $strictMode = false)
    {
        return $this->filter($this->_createMatcherFilter($conditions, $strictMode));
    }
     ...
     *
     */
    public function firstMatch(array $conditions, $strictMode = false)
    {
        return $this->match($conditions, $strictMode)->first();
    }
     ...
     */
    public function stopWhen($condition, $strictMode = false)
    {
        if (!is_callable($condition)) {
            $condition = $this->_createMatcherFilter($condition, $strictMode);
        }
